                          ...
                          <div className="flex gap-6 my-[4%] w-full max-[1000px]:flex-col items-center justify-center">
                            <h4
                              ...
                              onClick={() => {
                                ...
                                setStep(14); // Start on-grid steps
                              }}
                            >
                              On Grid
                            </h4>
                            <h4
                              ...
                              onClick={() => {
                                ...
                                setStep(28); // Start off-grid steps
                              }}
                            >
                              Off Grid
                            </h4>
                        ...
                        <div>
                          ...
                          {isEmpanelled && step >= 14 && step < 21 && (
                            <div>
                              ...
                              {isEmpanelled && step >= 17 && step < 19 && (
                                <div>
                                  {step === 17 && (
                                    <AttachmentsSection
                                      formData={formData}
                                      changeHandle={handleFileChange}
                                    />
                                  )}
                                  {step === 18 && (
                                    <CapacitytoInstall
